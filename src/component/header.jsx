    ...
    <header className="bg-white shadow-md py-4 relative z-50">
      <div className="container mx-auto px-4 flex justify-between items-center">        
        ...
        <nav className="hidden md:flex gap-6">
          ...
          <a href="" className="text-white-700 hover:text-blue-600">Product</a>
          <a href="" className="text-white-700 hover:text-blue-600">Contact</a>
        </nav>
        <div>
          <button
      ...
      <div className={`fixed top-0 left-0 h-full w-2/3 bg-white shadow-lg transform transition-transform duration-300 ease-in-out md:hidden ${menuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        ...
        <nav className="flex flex-col gap-6 px-6">
          ...
          <a href="" className="text-gray-700 hover:text-blue-600" onClick={() => setMenuOpen(false)}>Product</a>
          <a href="" className="text-gray-700 hover:text-blue-600" onClick={() => setMenuOpen(false)}>Contact</a>
        </nav>
      </div>
